...
export default function Navbar() {
  ...
  return (
    <Box zIndex={3} position={"fixed"} w={"100%"} bg={"#c62123"}>
      <Flex
        // position={"fixed"}
        // bg={"#003380"}
    ...
    >
      <Stack direction={"row"} align={"center"}>
        ...
        <Flex
          ...
          flex={1}
        >
          <Icon color={"#c62123"} w={5} h={5} as={ChevronRightIcon} />
        </Flex>
      </Stack>
    </Link>
  );
...
const MobileNav = () => {
  return (
    ...
    >
      {NAV_ITEMS.map((navItem) => (
        <MobileNavItem color={"white"} key={navItem.label} {...navItem} />
      ))}
    </Stack>
  );
};
