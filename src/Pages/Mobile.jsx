      ...
      >
        ...
        <Box p="6">
          ...
          <Flex mt="1" justifyContent="space-between" alignContent="center">
            ...
            >
              {name ||
                "Redmi 10A 32 GB, 3 GB RAM, Charcoal Black, Mobile Phone(492850145)"}
            </Box>
            <Tooltip
              label="Add to cart"
              bg="white"
...
const Mobile = () => {
  ...
  useEffect(() => {
    axios(
      `https://electronicsproductdata.onrender.com/products?_page=${page}&_limit=12&q=${search}&_sort=${sort}&_order=${order}&category=Mobile`
    ).then((res) => {
      setData(res.data);
  ...
  High To Low 
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr )" }}>
        <Select
          ...
          w={"120px"}
          border={"none"}
          bg={useColorModeValue("#003380", '"#c62123"')}
          color={useColorModeValue("white", "#c62123")}
          _hover={{
            transform: "translateY(2px)",
            bg: "#c62123",
            boxShadow: "lg",
