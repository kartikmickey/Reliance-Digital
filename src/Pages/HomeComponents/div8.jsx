...
//   https://electronicsproductdata.onrender.com/products?_page=1&_limit=5&category=HomeAppliances
...
const Div8 = () => {
  ...
  useEffect(() => {
    axios(
      `https://electronicsproductdata.onrender.com/products?_page=${page}&_limit=4&category=Laptop&brand=HP`
    ).then((res) => {
      setData(res.data);
  ...
  return (
    ...
    >
      ...
      >
        HP Special - Laptops and Peripherals
        <button
          style={{
